...
<body>
    ...
    <button onclick="window.location.href='./pages/inscription.php';" class="btn  rounded-full border-solid border-2 border-transparent bg-slate-300 m-2 rounded">Connexion</button>
    <button onclick="window.location.href='./pages/inscription.php';" class="btn  rounded-full border-solid border-2 border-transparent bg-slate-300 m-2 rounded">Créer un compte</button>
