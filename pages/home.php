            ...
            <div class="wrapper">
                ...
                <div class="head_post">
                    <div class="create_post">
                        <form method="POST" action="../bin/addpost.php" enctype="multipart/form-data">
                            <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-50 dark:border-gray-600">
                                <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-50">
                                    ...
                                    <textarea id="newPost" rows="4" name="newPost"class="w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-50 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write a comment..." required></textarea>
                                </div>
